...
All done using Binary Search. Based off my swift code for [Queenfisher](https://github.com/fadeldeveloper/Queenfisher)

## Install

`npm i github:fadeldeveloper/keyed-db`
...
``` ts
import KeyedDB from '@fadeldeveloper/keyed-db'
